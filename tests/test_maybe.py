...
from hask3 import Read, Show, Eq, Functor, Applicative
from hask3 import Monad, Num, Foldable, Traversable
from hask3 import Typeclass, L

from hask3 import H, sig, __, t
